...
namespace RevitAddinAcademy
{
    ...
    public class Command_DeleteBackupFiles : IExternalCommand
    {
        ...
        internal string WriteListToTxt(List<string> stringList, string filePath)
        {
            ...
            string fullPath = filePath + @"\" + fileName;    //Use the @ symbol to indicate the \ shouldn't be an escape character
